...
public class ObjectifJardinier extends Objectif {
    ...
    public String toString() {
        ...
        switch (identifiant) {
            case 16:
                return "Objectif " + identifiant + " : Quatre bambous jaunes sur une parcelle jaune avec amenagement bassain, Points: 5";
            case 17:
                return "Objectif " + identifiant + " : Quatre bambous jaunes sur une parcelle jaune sans amenagement, Points: 6";
            case 18:
                return "Objectif " + identifiant + " : Plus de 2 parcelles roses contiennent exactement 3 bambous roses chacune, Points: 6";
            case 19:
                return "Objectif " + identifiant + " : Plus de 3 parcelles jaunes contiennent exactement 3 bambous jaunes chacune, Points: 7";
            case 20:
            ...
            case 24:
                return "Objectif " + identifiant + " : Quatre bambous jaunes sur une parcelle jaune avec amenagement engrais, Points: 4";
            case 25:
                return "Objectif " + identifiant + " : Quatre bambous jaunes sur une parcelle jaune avec amenagement enclos, Points: 5";
            case 26:
                return "Objectif " + identifiant + " : Quatre bambous roses sur une parcelle rose avec amenagement engrais, Points: 5";
            case 27:
                return "Objectif " + identifiant + " : Quatre bambous roses sur une parcelle rose avec amenagement bassin, Points: 6";
            case 28:
                return "Objectif " + identifiant + " : Quatre bambous roses sur une parcelle rose avec amenagement enclos, Points: 6";
            case 29:
                return "Objectif " + identifiant + " : Quatre bambous roses sur une parcelle rose sans amenagement, Points: 7";
            case 30:
