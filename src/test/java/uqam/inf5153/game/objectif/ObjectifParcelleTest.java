...
public class ObjectifParcelleTest {
    ...
    public void testAppliquerObjectif_2() {
        ...
        ParcelleVerte p3=new ParcelleVerte();
        p3.setIrriguee(true);
        ParcelleVerte p4=new ParcelleVerte();
        p4.setIrriguee(true);
        Joueur joueur =new Joueur();
        joueur.placerParcelleDansPlateau(plateau,p1,2,1);
        joueur.placerParcelleDansPlateau(plateau,p2,0,2);
        joueur.placerParcelleDansPlateau(plateau,p3,2,3);
        joueur.placerParcelleDansPlateau(plateau,p4,0,4);
    ...
    public void testAppliquerObjectif_3() {
        ...
        PlateauDeJeu plateau =new PlateauDeJeu();
        ParcelleJaune p1=new ParcelleJaune();
        p1.setIrriguee(true);
        ParcelleJaune p2=new ParcelleJaune();
        p2.setIrriguee(true);
        ParcelleRose p3=new ParcelleRose();
        p3.setIrriguee(true);
        ParcelleRose p4=new ParcelleRose();
        p4.setIrriguee(true);
        Joueur joueur =new Joueur();
        joueur.placerParcelleDansPlateau(plateau,p3,2,1);
        joueur.placerParcelleDansPlateau(plateau,p1,0,2);//jaune
        joueur.placerParcelleDansPlateau(plateau,p2,2,3);//jaune
        joueur.placerParcelleDansPlateau(plateau,p4,4,2);
    ...
    public void testAppliquerObjectif_5() {
        ...
        PlateauDeJeu plateau =new PlateauDeJeu();
        ParcelleRose p1= new ParcelleRose();
        p1.setIrriguee(true);
        ParcelleRose p2= new ParcelleRose();
        p2.setIrriguee(true);
        ParcelleVerte p3=new ParcelleVerte();
        p3.setIrriguee(true);
        ParcelleVerte p4=new ParcelleVerte();
        ...
        Joueur joueur =new Joueur();
        joueur.placerParcelleDansPlateau(plateau,p3,2,1);
        joueur.placerParcelleDansPlateau(plateau,p1,0,2);//rose
        joueur.placerParcelleDansPlateau(plateau,p2,2,3);//rose
        joueur.placerParcelleDansPlateau(plateau,p4,4,2);
    ...
    public void testAppliquerObjectif_6_et_8() {
        ...
        ParcelleJaune p2=new ParcelleJaune();
        p2.setIrriguee(true);
        ParcelleJaune p3=new ParcelleJaune();
        p3.setIrriguee(true);
        ParcelleJaune p4=new ParcelleJaune();
        p4.setIrriguee(true);
        Joueur joueur =new Joueur();
        //p1,p2 et p3  produit un ligne curbé jaune (objectif8)
        joueur.placerParcelleDansPlateau(plateau,p1,-2,1);
        // p2, p3 et p4 créent un ligne droit jaune.
        joueur.placerParcelleDansPlateau(plateau,p2,2,1);
        joueur.placerParcelleDansPlateau(plateau,p3,0,2);
        joueur.placerParcelleDansPlateau(plateau,p4,-2,3);
